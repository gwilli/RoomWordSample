...
import io.atomicrobot.greg.roomwordsample.viewmodel.WordViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            Snackbar.make(findViewById(R.id.coordinator_layout), R.string.empty_not_saved, Snackbar.LENGTH_LONG).show();
        }
    }
}
